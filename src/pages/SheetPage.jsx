          ...
          <div className="sheet-main">
            <div className="pdf-preview">
              <div className="pdf-preview-inner">
                <object
                  data={`/pdfs/${sheet.file}#view=FitH`}
                  type="application/pdf"
                  className="pdf-embed"
                  aria-label={`${sheet.title} cheat sheet preview`}
                >
                  <div className="pdf-fallback">
                    <svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round" style={{ color: 'var(--dim)', marginBottom: 12 }}>
                      <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/>
                      <polyline points="14 2 14 8 20 8"/>
                    </svg>
                    <p>PDF preview not available in this browser.</p>
                    <button className="dl-btn-lg" onClick={handleDownload}>Download to view</button>
                  </div>
                </object>
              </div>
            </div>
